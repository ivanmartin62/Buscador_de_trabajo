...
def test_no_duplica_tarjeta_ni_acepta_enlace_ejecutable() -> None:
    html = """
    <div><h3>Concurso</h3><ul><li>Derecho</li><li>1 cargo</li></ul>
    <span>Inscripción abierta</span><span>Inscripción abierta</span>
    <a href="javascript:alert(1)">Ver</a></div>
    """

    ofertas = ConcursarScraper().parse(html)

    assert len(ofertas) == 1
    assert str(ofertas[0].url_original) == "https://concursar.miportal.gob.ar/"
